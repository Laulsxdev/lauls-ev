...
// ponytail: placeholders in every cell — Excel drops trailing empty columns
const P = "0";
const TEMPLATE_ROWS = [
  ["driver","Rajesh Kumar","+91 98765 43210","Sector 21 Gurugram","1234 5678 9012","DL-0420180012345","2028-06-12","KA01-EV-1024",P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P].join(","),
  ["vehicle",P,P,P,P,P,P,P,"RC-001","2023-03-15","Refrigerated 20ft","Tata Motors","2023-01-10","2023-03-15","92","240","active",P,P,P,P,P,P,P,P,P,P,P,P].join(","),
  ["trip",P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,P,"Rajesh Kumar","RC-001","2026-01-15","Bengaluru Depot","Hyderabad","280","3500","75.2","6.0","380","5.1","completed"].join(","),
];
